...
#define SERVER_TIME_SLOT        100
    ...
    typedef enum {
        ...
        APP_TCPIP_WAIT_FOR_UDP_CONNECTION,
        APP_STATE_SERVICE_TASKS,
        /* TODO: Define states used by the application state machine. */
        APP_STATE_FIND_MASTER,
		APP_STATE_DETECT_MASTER,
		APP_STATE_MASTER_LOST,
		APP_STATE_DEVICE_LOST,
		APP_STATE_REGISTER_N_NEW_DEVICES,
		APP_STATE_REGISTER_NEW_DEVICE,
